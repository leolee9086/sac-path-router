...
/** A request handler. */
export type ExpressHandler = (request: ExpressRequest, response: ExpressResponse, next: (error?: unknown) => unknown) => unknown;
/** An error handler: four parameters, as in Express. */
export type ExpressErrorHandler = (error: unknown, request: ExpressRequest, response: ExpressResponse, next: (error?: unknown) => unknown) => unknown;
/** Router options. */
